...
void name(){
	...
	double phone;
	char gender[8];
	fptr=fopen("ganesh.txt","ab+");//ab+ gives us the ability of writing the function and add the second data in the existing one...
	if(fptr==NULL){
...
void passcode(void){
	...
	if(strcmp(pass,passcodes)==0){
		...
		gotoxy(30,6);
		printf("You entered the wrong passcode.");
		Sleep(700);
		system("cls");
		passcode();
}
